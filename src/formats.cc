...
format_specification formats[] =
{
	...
	{ "314" },
	{ "unixv1",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::UNIX_V1, AOutFormat::MAGIC_V1); },
		"UNIX Version 1 a.out executable" },
	{ "unixv2",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::UNIX_V1, AOutFormat::OMAGIC); },
