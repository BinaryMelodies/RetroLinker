...
format_specification formats[] =
{
	...
	{ "applesingle-bin",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AppleDriver>(AppleDriver::FILE_TYPE_BIN, AppleDriver::TARGET_APPLESINGLE); },
	...
	{ "applesingle-sys",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AppleDriver>(AppleDriver::FILE_TYPE_SYS, AppleDriver::TARGET_APPLESINGLE); },
