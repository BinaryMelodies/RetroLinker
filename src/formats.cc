...
format_specification formats[] =
{
	...
	/* a.out */
	{ "aout",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT); },
		"a.out executable" },
	{ "a.out" },
	{ "omagic",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT, AOutFormat::OMAGIC); },
		"a.out impure (OMAGIC) executable" },
	{ "407" },
	{ "nmagic",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT, AOutFormat::NMAGIC); },
		"a.out pure (NMAGIC) executable" },
	{ "410" },
	{ "imagic", // reflects the UNIX linker -i flag
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT, AOutFormat::MAGIC_SEPARATE); },
		"a.out split I&D executable" },
	{ "411" },
	{ "zmagic",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT, AOutFormat::ZMAGIC); },
		"a.out demand paged (ZMAGIC) executable" },
	{ "413" },
	{ "qmagic",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::DEFAULT, AOutFormat::QMAGIC); },
		"a.out demand paged executable with unmapped zero page (QMAGIC)" },
	{ "314" },
	{ "unixv1",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::UNIX_V1_V2, AOutFormat::MAGIC_V1); },
		"UNIX Version 1 a.out executable" },
	{ "unixv2",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::UNIX_V1_V2, AOutFormat::OMAGIC); },
		"UNIX Version 2 a.out executable" },
	{ "unixv7",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::UNIX); },
		"UNIX Version 7 a.out executable" },
	{ "unix" },
	{ "aout_bsd",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateWriter(AOutFormat::BSD); },
		"2.11BSD or 3BSD a.out executable" },
	{ "djgppv1",
	...
	/* Classic Macintosh */
	{ "code",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_RESOURCE_FORK); },
		"Classic Macintosh 'CODE' resource executable, resource fork only" },
	{ "resource" },
	{ "rsrc" },
	{ "basilisk",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_DATA_FORK, Apple::Classic68KDriver::PRODUCE_RESOURCE_FORK | Apple::Classic68KDriver::PRODUCE_FINDER_INFO); },
		"Classic Macintosh 'CODE' resource executable with resource fork and Finder Info in separate .rsrc, .finf folders" },
	{ "macos",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_DATA_FORK, Apple::Classic68KDriver::PRODUCE_RESOURCE_FORK | Apple::Classic68KDriver::PRODUCE_FINDER_INFO | Apple::Classic68KDriver::PRODUCE_APPLE_DOUBLE | Apple::Classic68KDriver::PRODUCE_MAC_BINARY); },
	...
	{ "apple" },
	{ "appledouble",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_DATA_FORK, Apple::Classic68KDriver::PRODUCE_APPLE_DOUBLE); },
		"Classic Macintosh 'CODE' resource executable, stored as AppleDouble format alongside an empty data fork" },
	{ "appledouble-only",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_APPLE_DOUBLE); },
		"Classic Macintosh 'CODE' resource executable, stored as AppleDouble format" },
	{ "applesingle",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_APPLE_SINGLE); },
		"Classic Macintosh 'CODE' resource executable, stored as AppleSingle format" },
	{ "mbin",
		[]() -> std::shared_ptr<Format> { return std::make_shared<Apple::Classic68KDriver>(Apple::Classic68KDriver::TARGET_MAC_BINARY); },
	...
	/* Adam format */
	{ "adam",
		[]() -> std::shared_ptr<Format> { return std::make_shared<SeychellDOS32::AdamFormat>(); },
		"Adam Seychell DOS32 and CandyMan DX64 DOS extenders 'Adam' format (.exe)" },
	{ "adam33",
		[]() -> std::shared_ptr<Format> { return std::make_shared<SeychellDOS32::AdamFormat>(SeychellDOS32::AdamFormat::FORMAT_33); },
		"Adam Seychell DOS32 DOS extender 3.3 'Adam' format (.exe)" },
	{ "adam35",
		[]() -> std::shared_ptr<Format> { return std::make_shared<SeychellDOS32::AdamFormat>(SeychellDOS32::AdamFormat::FORMAT_35); },
		"Adam Seychell DOS32 DOS extender 3.5 beta 'Adam' format (.exe)" },
	{ "dx64",
	...
	{ "apple-bin-dos33",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AppleDriver>(AppleDriver::FILE_TYPE_BIN, AppleDriver::TARGET_DOS33); },
		"Apple 8-bit BIN file format with DOS 3.3 header" },
	{ "apple-bin-raw",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AppleDriver>(AppleDriver::FILE_TYPE_BIN, AppleDriver::TARGET_RAW); },
	...
	{ "apple-sys",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AppleDriver>(AppleDriver::FILE_TYPE_SYS, AppleDriver::TARGET_RAW); },
...
//	{ std::string("\x01\x01"),            0, FORMAT_AOUT,    "Little endian a.out, UNIX/RT lpd" }, // conflicts with CMD format
	...
	{ std::string("\x01h"),               0, FORMAT_COFF,    "AT&T WE32K COFF executable (UNIX)" },
	{ std::string("\x01i"),               0, FORMAT_COFF,    "AT&T WE32K COFF executable (UNIX)" },
	{ std::string("\x01p"),               0, FORMAT_COFF,    "AT&T WE32K COFF executable (UNIX)" },
	{ std::string("\x01q"),               0, FORMAT_COFF,    "AT&T WE32K COFF executable (UNIX)" },
	...
	{ std::string("x\x01"),               0, FORMAT_COFF,    "DEC VAX COFF executable (UNIX)" },
	{ std::string("}\x01"),               0, FORMAT_COFF,    "DEC VAX COFF executable (UNIX)" },
