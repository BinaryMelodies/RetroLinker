...
format_specification formats[] =
{
	...
	{ "aout_net" },
	{ "aout16le",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateReader(2, ::LittleEndian); },
		"16-bit little endian a.out (parsing only)" },
	{ "aout16" },
	{ "aout32le",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateReader(4, ::LittleEndian); },
		"32-bit little endian a.out (parsing only)" },
	{ "aout32le_net",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateReader(4, ::LittleEndian, AOutFormat::NETBSD); },
		"32-bit little endian a.out for NetBSD (parsing only)" },
	{ "aout32be",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateReader(4, ::BigEndian); },
		"32-bit big endian a.out (parsing only)" },
	{ "aout32be_free",
		[]() -> std::shared_ptr<Format> { return AOutFormat::CreateReader(4, ::BigEndian, AOutFormat::FREEBSD); },
