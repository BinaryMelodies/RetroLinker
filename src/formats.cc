...
format_specification formats[] =
{
	...
	/* a.out */
	{ "aout",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AOutFormat>(AOutFormat::DJGPP1); },
		"32-bit a.out executable (80386) with ZMAGIC for GO32/DJGPP version up to 1.10 (.exe)" },
	{ "a.out" },
	{ "djgppv1" },
	{ "zmagic" },
	{ "pdos32",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AOutFormat>(AOutFormat::PDOS386); },
		"32-bit a.out executable (80386) with OMAGIC for PDOS/386 (.exe) (obsolete)" },
	{ "pdos386" },
	{ "omagic" },
	{ "aout_linux",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AOutFormat>(AOutFormat::LINUX); },
		"32-bit a.out executable (80386) for Linux" },
	{ "aout_freebsd",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AOutFormat>(AOutFormat::FREEBSD); },
		"32-bit a.out executable (80386) for FreeBSD" },
	{ "aout_netbsd",
		[]() -> std::shared_ptr<Format> { return std::make_shared<AOutFormat>(AOutFormat::NETBSD); },
