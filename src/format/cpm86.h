...
namespace DigitalResearch
{
	...
	public:
		...
		enum format_type
		{
			...
			FORMAT_COMPACT,
			/**
			 * @brief FlexOS 286 format, running in protected mode, possible SRTL shared libraries
			 */
			FORMAT_FLEXOS,
			/**
			 * @brief FlexOS 286 fastload format as generated by postlink, with an LDT image in file
			 */
			FORMAT_FASTLOAD,
		};
		...
		public:
			...
			Linker::Option<std::optional<std::string>> srtl{"srtl", "Generate shared run-time library, parameter: <library name>.<major version>.<minor version>[.<optional flags as hexadecimal value>]"};
