...
bool GSOutputDriver::SupportedSupplementaryFormat(OutputDriver::produce_format_t produce)
{
	return !(produce & ~(OutputDriver::PRODUCE_RESOURCE_FORK | OutputDriver::PRODUCE_APPLE_DOUBLE | OutputDriver::PRODUCE_NAPS_SUFFIX));
}
